...
RUN pip3 install git+https://github.com/DISHDevEx/dish-devex-sdk.git@aakash/test-emr-changes
RUN pip3 install git+https://github.com/DISHDevEx/eks-ml-pipeline.git@aakash/backup-emr
