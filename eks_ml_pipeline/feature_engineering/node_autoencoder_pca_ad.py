...
def node_fe_pipeline(feature_group_name, feature_version,
    ...
    #pre processing
    node_features_data, node_processed_data = node_ad_preprocessing(feature_group_name, feature_version, partition_year, partition_month, partition_day, partition_hour, spark_config_setup, bucket_name_raw_data, folder_name_raw_data)
