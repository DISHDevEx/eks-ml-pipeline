...
def node_autoencoder_input():
    ...
    train_data_filename = "training_2022_9_29_1.npy" #add info about actual path
    test_data_filename = "testing_2022_9_29_1.npy" #add info about actual path
...
def pod_autoencoder_input():
    ...
    feature_input_version = "v0.0.2"  
    data_bucketname = "dish-5g.core.pd.g.dp.eks.logs.e"
    train_data_filename = "training_2022_9_9_1.npy" #add info about actual path
    test_data_filename = "testing_2022_9_9_1.npy" #add info about actual path
...
def container_autoencoder_input():
    ...
    feature_input_version = "v0.0.2"  
    data_bucketname = "dish-5g.core.pd.g.dp.eks.logs.e"
    train_data_filename = "training_2022_5_5_1.npy" #add info about actual path
    test_data_filename = "testing_2022_5_5_1.npy" #add info about actual path
    
    save_model_local_path = "../container_autoencoder"
    model_bucketname = 'dish-5g.core.pd.g.dp.eks.logs.e'
    model_name = 'container_autoencoder_ad'
    model_version = "v0.0.1-test" #'v0.0.2' #add info about actual path for model
